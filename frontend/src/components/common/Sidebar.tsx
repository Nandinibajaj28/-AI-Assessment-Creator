  ...
  return (
    <aside className="w-full max-w-[236px] rounded-[14px] bg-white px-4 pb-4 pt-5 shadow-[0_14px_36px_rgba(15,23,42,0.12)]">
      ...
      <div className="mt-[156px]">
        <SidebarNavItem item={{ label: "Settings", icon: <SettingsIcon /> }} />
  ...
  return (
    <button
      ...
      className={[
        ...
        item.active ? "bg-[#efefef]" : "hover:bg-[#f6f6f6]",
      ].join(" ")}
    >
      <span className="flex min-w-0 items-center gap-[9px]">
        <span className={item.active ? "text-[#3a3a3a]" : "text-[#7b7b7b]"}>{item.icon}</span>
        <span
          className={[
            "truncate text-[13.5px] leading-none",
            item.active ? "font-medium text-[#323232]" : "font-normal text-[#747474]",
          ].join(" ")}
        >
          {item.label}
        </span>
...
function GroupsIcon() {
  return (
    <svg width="14" height="14" viewBox="0 0 14 14" fill="none" aria-hidden="true">
      <path
        d="M4.6 6.1C5.70457 6.1 6.6 5.20457 6.6 4.1C6.6 2.99543 5.70457 2.1 4.6 2.1C3.49543 2.1 2.6 2.99543 2.6 4.1C2.6 5.20457 3.49543 6.1 4.6 6.1Z"
        stroke="currentColor"
        strokeWidth="1.2"
      />
      <path
        d="M9.8 5.5C10.6837 5.5 11.4 4.78366 11.4 3.9C11.4 3.01634 10.6837 2.3 9.8 2.3C8.91635 2.3 8.2 3.01634 8.2 3.9C8.2 4.78366 8.91635 5.5 9.8 5.5Z"
        stroke="currentColor"
        strokeWidth="1.2"
      />
      <path
        d="M1.8 11.4C2.25 9.82 3.4 8.9 4.9 8.9C6.4 8.9 7.55 9.82 8 11.4"
        stroke="currentColor"
        strokeWidth="1.2"
        strokeLinecap="round"
      />
      <path
        d="M8.3 10.95C8.63333 9.85 9.41667 9.2 10.65 9.2C11.2435 9.2 11.7725 9.35049 12.237 9.65147"
        stroke="currentColor"
        strokeWidth="1.2"
        strokeLinecap="round"
      />
...
function LibraryIcon() {
  return (
    <svg width="14" height="14" viewBox="0 0 14 14" fill="none" aria-hidden="true">
      <path
        d="M7 12.1C9.43005 12.1 11.4 10.1301 11.4 7.7C11.4 5.26995 9.43005 3.3 7 3.3C4.56995 3.3 2.6 5.26995 2.6 7.7C2.6 10.1301 4.56995 12.1 7 12.1Z"
        stroke="currentColor"
        strokeWidth="1.2"
      />
...
function SettingsIcon() {
  return (
    <svg width="14" height="14" viewBox="0 0 14 14" fill="none" aria-hidden="true">
      <path
        d="M7 4.85C5.81259 4.85 4.85 5.81259 4.85 7C4.85 8.18741 5.81259 9.15 7 9.15C8.18741 9.15 9.15 8.18741 9.15 7C9.15 5.81259 8.18741 4.85 7 4.85Z"
        stroke="currentColor"
        strokeWidth="1.2"
      />
      <path
        d="M11.05 7C11.05 6.71341 11.0177 6.43435 10.9565 6.16621L12.05 5.32553L11.1 3.67917L9.77346 4.1522C9.36086 3.82425 8.88264 3.57598 8.36069 3.42775L8.15 2H5.85L5.63931 3.42775C5.11736 3.57598 4.63914 3.82425 4.22654 4.1522L2.9 3.67917L1.95 5.32553L3.0435 6.16621C2.98234 6.43435 2.95 6.71341 2.95 7C2.95 7.28659 2.98234 7.56565 3.0435 7.83379L1.95 8.67447L2.9 10.3208L4.22654 9.8478C4.63914 10.1758 5.11736 10.424 5.63931 10.5722L5.85 12H8.15L8.36069 10.5722C8.88264 10.424 9.36086 10.1758 9.77346 9.8478L11.1 10.3208L12.05 8.67447L10.9565 7.83379C11.0177 7.56565 11.05 7.28659 11.05 7Z"
        stroke="currentColor"
        strokeWidth="1.1"
